...
# features_0 = ['LotArea', 'YearBuilt', '1stFlrSF', '2ndFlrSF', 'FullBath', 'BedroomAbvGr', 'TotRmsAbvGrd',
...
features_1 = ['LotArea', 'YearBuilt', '1stFlrSF', '2ndFlrSF', 'FullBath', 'BedroomAbvGr', 'TotRmsAbvGrd',
           'Neighborhood','Condition1','Condition2','HouseStyle','OverallQual','OverallCond',
           'YearRemodAdd','ExterQual','ExterCond','YrSold',
           'KitchenAbvGr','KitchenQual']

training_data = training_data_full[features_1]
...
categorical_cols = [cname for cname in training_data.columns if ((training_data[cname].nunique() <= 10) & (training_data[cname].dtype == 'object'))]
...
def best_learning_rate():
    ...
    index = 1
    for i in range (1,10):
        test_model = XGBRegressor(n_estimators=400,learning_rate=0.01*i,random_state=1)
